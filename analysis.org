...
|--------------------------+-----------+-----------+----------+----------+----------+---------+----------+-----------+----------|
| D10-3.HG7LFALXX.1        | 136351407 |  94763529 | (69.50%) | 29291603 | (21.48%) | 2160126 | (1.58%)  |  10136149 | (7.43%)  |
|--------------------------+-----------+-----------+----------+----------+----------+---------+----------+-----------+----------|
| D10-8.HG7LFALXX.1        | 124131681 |  85789083 | (69.11%) | 27070194 | (21.81%) | 1929487 | (1.55%)  |   9342917 | (7.53%)  |
|--------------------------+-----------+-----------+----------+----------+----------+---------+----------+-----------+----------|
| D10-7.HGF7YALXX.5        | 197515336 | 161770051 | (81.90%) | 23747201 | (12.02%) | 2403047 | (1.22%)  |   9595037 | (4.86%)  |
|--------------------------+-----------+-----------+----------+----------+----------+---------+----------+-----------+----------|
...
| D10-3.HG7LFALXX.1     | ILLUMINA | HG7LFALXX.1       | D10-3               |
| D10-7.HGF7YALXX.5     | ILLUMINA | HGF7YALXX.5       | D10-7               |
| D10-8.HG7LFALXX.1     | ILLUMINA | HG7LFALXX.1       | D10-8               |
...
#+HEADER: :shebang #!/bin/bash :tangle analysis/d.align/new_clean.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N SRA_clean -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[141:143,] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/erc-share/etc/swsetup/swsetup.pl $*`; }
  swsetup samtools
...
seq -w 0 46 |  parallel  mkdir {} ';' cd {} ';' bam2consensus -g $DIR/db/D5.CDS_range.gff.{}.gff -m 10 -f 0.5 $bams
#+END_SRC
...
#+HEADER: :shebang #!/bin/bash :tangle analysis/phylo/mb/run.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N MrBayes -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh  :var DIR=(file-name-directory buffer-file-name)
PATH=/usr/local/igbb/mrbayes-3.2.5/bin/:/usr/local/mpi/x86_64/openmpi-1.8.2/bin:$PATH
LD_LIBRARY_PATH=/usr/local/mpi/x86_64/openmpi-1.8.2/lib:$LD_LIBRARY_PATH
cd $DIR/analysis/phylo/mb/run/


S=$[ ${PBS_ARRAYID} * 50 + 1 ]
E=$[ ${PBS_ARRAYID} * 50 + 50]

for file in $(find $DIR/analysis/phylo/mb -name *.nxs | sed -n ${S},${E}p); do
    mpirun -np 16 mb $file > $file.stdout
done
#+END_SRC
...
#+NAME: sample_tbl
| Sample Name | Library            | Genome Size (Mb) | Sampling (Mb) | Number of reads |
|-------------+--------------------+------------------+---------------+-----------------|
| D10-8o      | D10-8.Gturn1.9     |              910 |           9.1 |          107059 |
| D10-3_      | D10-3.HG7LFALXX.1  |              910 |           9.1 |          107059 |
| D10-7_      | D10-7.HGF7YALXX.5  |              910 |           9.1 |          107059 |
| D10-8_      | D10-8.HG7LFALXX.1  |              910 |           9.1 |          107059 |
| D11-1_      | D11-1.Gschw1.7     |              929 |          9.29 |          109295 |
| D1-2__      | D1-2.Gthur1.7      |              841 |          8.41 |           98942 |
| D1-35_      | D1-35.Gthur2.5     |              841 |          8.41 |           98942 |
| D2-1-6      | D2-1-6.Garmo1.5    |              856 |          8.56 |          100706 |
| D3-D-2      | D3-D-27.Gdavi1.1   |              910 |           9.1 |          107059 |
| D3-K-5      | D3-K-57.Gklot1.6   |              880 |           8.8 |          103530 |
| D4-12_      | D4-12.Garid1.2     |              919 |          9.19 |          108118 |
| D5-6__      | D5-6.Graim2.1      |              880 |           8.8 |          103530 |
| D5-8__      | D5-8.Graim1.7      |              880 |           8.8 |          103530 |
| D6-5__      | D6-5.Ggoss2.2      |              841 |          8.41 |           98942 |
| D6-7__      | D6-7.Ggoss1.3      |              841 |          8.41 |           98942 |
| D7-4__      | D7-4.Globa1.1      |              934 |          9.34 |          109883 |
| D8-8__      | D8-8.Gtril2.1      |              851 |          8.51 |          100118 |
| D8-9__      | D8-9.Gtril1.1      |              851 |          8.51 |          100118 |
| D9-4__      | D9-4.Glaxu1.1      |              934 |          9.34 |          109883 |
| A1-97_      | A1-97              |             1667 |         16.67 |          196118 |
| A1-155      | A1-155             |             1667 |         16.67 |          196118 |
| A2_101      | A2_1011            |             1698 |         16.98 |          199765 |
| A2_34_      | A2_34              |             1698 |         16.98 |          199765 |
| D5_ref      | D5_ref             |              880 |           8.8 |          103530 |
| F1-1__      | F1-1               |             1311 |         13.11 |          154236 |
| D2-2__      | D2-2.HFJ7YBGXX.1   |              910 |           9.1 |          107059 |
| D3K-56      | D3K-56.HFJ7YBGXX.1 |              880 |           8.8 |          103530 |
| D4-185      | D4-185.HFJ7YBGXX.1 |              919 |          9.19 |          108118 |
| D7-157      | D7-157.HFJ7YBGXX.1 |              934 |          9.34 |          109883 |
| D5_2__      | D5_2               |              880 |           8.8 |          103530 |
| D5_4__      | D5_4               |              880 |           8.8 |          103530 |
| D5_31_      | D5_31              |              880 |           8.8 |          103530 |
| D5_53_      | D5_53              |              880 |           8.8 |          103530 |
...
#parallel -k --colsep '\t' reservoir_sample -l 85 -n {2} -s {5} $DIR/trim/{1}.PE.R1.fq.gz ::: "$libs" >  $DIR/analysis/clustering/sample.fa

for name in "${!libs[@]}"; do
    readarray -t lib <<<"${libs[$name]}"
    reservoir_sample -l 85 -n $name -s ${lib[3]} $DIR/trim/${lib[0]}.PE.R1.fq.gz
done > $DIR/analysis/clustering/sample.fa
#+END_SRC
...
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name)
  ...
  find $DIR/analysis/clustering/seqClust/clustering/clusters -name '*_domains.csv' |\
      ...
      sed -e 's#[^\t]*/##' -e 's/_domains.csv//' | tr -d '"' | sort -n |\
      awk 'length(head)==0 {printf "Cluster\tLineage"} head != $1 {printf "\n%s\t%s", $1,$2} head==$1{printf ",%s", $2} {head=$1}' |\
      paste - $DIR/analysis/clustering/seqClust/clustering/comparativeAnalysis_table_clusters_counts.csv \
            > $DIR/analysis/clustering/seqClust/clustering/comparative_analysis_counts.domains.txt

  perl bin/annotate.pl analysis/clustering/seqClust/clustering/RM-custom_output_tablesummary.csv |
     paste - $DIR/analysis/clustering/seqClust/clustering/comparative_analysis.domains.txt \
     > $DIR/analysis/clustering/seqClust/clustering/comparative_analysis.domains.annotated.txt

  perl bin/annotate.pl analysis/clustering/seqClust/clustering/RM-custom_output_tablesummary.csv |
     paste - $DIR/analysis/clustering/seqClust/clustering/comparative_analysis_counts.domains.txt \
     > $DIR/analysis/clustering/seqClust/clustering/comparative_analysis_counts.domains.annotated.txt

  perl bin/annotate.pl analysis/clustering/seqClust/clustering/RM-custom_output_tablesummary.csv |
     paste - $DIR/analysis/clustering/seqClust/clustering/comparativeAnalysis_table_clusters_counts.csv \
     > $DIR/analysis/clustering/seqClust/clustering/comparative_analysis_counts.annotated.txt
...
#+BEGIN_SRC perl :tangle analysis/clustering/te_histo.pl
#!/usr/bin/perl
...
while(<>){
    ...
    $histo->{join "\t", map{substr($_, 0, 6)} @$id}->{$pid}++;
}    
...
#+HEADER: :shebang #!/bin/bash :tangle analysis/clustering/te_dating.sh :mkdirp yes
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name)
PATH=$PATH:$DIR/bin/repeatexplorer/tgicl_linux/bin:/usr/local/R-3.2.3/bin/
...
# READ HISTOGRAM
d<-read.table(args[1], col.names=c("Query", "Subject", "PID", "Count"))

# Create a data frame for each accession
d.split <- split(d[d$Query == d$Subject,c("PID","Count")], d[d$Query == d$Subject, 'Query'])
...
#        formatdb -p F -i $file
        ...
        #              mgblast -d $file -p85 -W18 -UT -X40 -KT -JF -F '"m D"' -v100000000 -b100000000 -D4 -C 55 -H30 > $(dirname $file)/TE_dating.blast

        perl $DIR/analysis/clustering/te_histo.pl $(dirname $file)/TE_dating.blast > $(dirname $file)/TE_dating.hist
...
#+HEADER: :shebang #!/usr/local/R-3.2.3/bin/Rscript :tangle analysis/clustering/te_dating.sh :mkdirp yes
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name)
classify <- function(d) {
if(nargs() != 1 | is.null(d)){
  return(NA)
}
if(dim(d)[1] < 3){
  return(NA)
...
acc <- c("D10-3_", "D10-7_", "D10-8_", "D10-8o", "D11-1_", "D1-2__",
         "D1-35_", "D2-1-6", "D2-2__", "D3-D-2", "D3-K-5", "D3K-56",
         "D4-12_", "D4-185", "D5_2__", "D5_31_", "D5_4__", "D5_53_",
         "D5-6__", "D5-8__", "D5_ref", "D6-5__", "D6-7__", "D7-157",
         "D7-4__", "D8-8__", "D8-9__", "D9-4__")

clusters = sub('.*_', '', list.dirs('seqClust/clustering/clusters', recursive=F))
data <- lapply(clusters, function(x) read.table(
             file.path('seqClust', 'clustering', 'clusters', paste0('dir_', x), 'TE_dating.hist'),
             col.names=c("Query", "Subject", "PID", "Count")))
names(data) <- clusters
data.split <- lapply(data, function(d) {
                         filter = as.character(d$Query) == as.character(d$Subject) & d$Query %in% acc
                         split(d[filter,c("PID","Count")],
                               d[filter, 'Query'])
                         })

class<-lapply(data.split, function(d) sapply(d[acc], classify))
table <- do.call(rbind, class)
write.table(table, file='TE_dating.table.txt', col.names=NA, sep='\t')
...
#+NAME:completed
| Species    | Path                                            | Number of Parts | Number of Pieces | esize |
|------------+-------------------------------------------------+-----------------+------------------+-------|
...
| D10-7.k115 | analysis/assemble/D10-7/D10-7.k115.scaffolds.fa |                 |                  |       |
...
#+HEADER: :shebang #!/bin/bash :tangle get.sh
#+BEGIN_SRC sh :var genomes=completed :var DIR=(file-name-directory buffer-file-name)
  while read -a lib; do 
    echo ${lib[0]}
    OUT_PATH=$(dirname ${lib[1]})
    mkdir -p $DIR/$OUT_PATH
    git annex get ${lib[1]} --from=origin
  done <<< "$genomes";
#+END_SRC
...
#+BEGIN_SRC sh :var genomes=not_filtered :var minimum_length=minimum_length :var DIR=(file-name-directory buffer-file-name)
  PERL5LIB=$PERL5LIB:~maa146/bin/lib
  while read -a lib; do 
    echo $lib
    OUT_PATH=$(dirname ${lib[1]})
...
| D10-7.k115 |      |      |       |      |     |    |       |                         |    |                                                                                                                                                                                                                   |
| total      | 828M |      |       |      |     |    |       |                         |    |                                                                                                                                                                                                                   |
| -rw-rw---- |    1 | 6502 | 11000 |    0 | Apr | 27 | 11:14 | D10-7.k115.filtered.fa  |    |                                                                                                                                                                                                                   |
| -rw-rw---- |    1 | 6502 | 11000 | 828M | Apr | 27 | 11:21 | D10-7.k115.renamed.fa   |    |                                                                                                                                                                                                                   |
| lrwxrwxrwx |    1 | 6502 | 11000 |  209 | Apr | 27 | 10:41 | D10-7.k115.scaffolds.fa | -> | ../../../.git/annex/objects/FJ/Kv/SHA256E-s872635277--235004723b03b1dae7818a3a08bbc4f0e3b835f6efa9071109b5e2e74497cf2c.fa/SHA256E-s872635277--235004723b03b1dae7818a3a08bbc4f0e3b835f6efa9071109b5e2e74497cf2c.fa |
...
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name) :var genomes=completed
  swsetup()
  {
    eval `/usr/erc-share/etc/swsetup/swsetup.pl $*`
  }
  ...
  PATH=$PATH:$DIR/analysis/annotation/busco/augustus_setup/scripts/:/usr/local/igbb/hmmer3.1b2/
  ...
  /usr/local/igbb/busco_v2/BUSCO.py -i $DIR/analysis/assemble/${lib[0]}/${lib[0]}.filtered.fa -l $DIR/analysis/annotation/busco/db/embryophyta_odb9/ -m genome -c 20 -o ${lib[0]} -r -t tmp_${lib[0]}
...
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name) :results output verbatim
  for file in $(find analysis/annotation/busco/run_D*/augustus_output/ -maxdepth 2 -name 'retraining_parameters' -type f); do
...
#+RESULTS:
: /scratch/thrash/shane.gossypiumD//analysis/annotation/busco/run_D10-7.k115/snap/D10-7.k115.hmm
...
* SNPs
+Workflow from [[https://www.broadinstitute.org/gatk/guide/best-practices][GATK Best Practices]]+
Workflow from [[http://www.htslib.org/workflow/][Samtools]]
** Pre-Processing
*** Split
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/dedup/split.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N split -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/local/swsetup/swsetup.pl $*`; }
  swsetup samtools

  PATH=$PATH:/usr/local/gnu/bin/:/usr/local/igbb/bamtools/bin
  LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/igbb/bamtools/lib/
  PICARD=/usr/local/igbb/picard-tools-1.140/picard.jar
  ALIGN=$DIR/analysis/SNP/dedup
  cd $ALIGN
  
  uniq=$(uniq <<< "$libs")
  parallel -j 5 'mkdir -p {}; cd {}; ln -s /work/thrash/shane.gossypiumD.annex//analysis/d.align/{}.all.bam {}.bam; ln -s /work/thrash/shane.gossypiumD.annex//analysis/d.align/{}.all.bam.bai {}.bam.bai; for chrom in {01..13}; do samtools view -bh {}.bam Chr${chrom} > {}.Chr_${chrom}.bam; done' <<<"$uniq"

#+END_SRC

*** Mark Duplicated
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/dedup/dedup.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N dedup -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/local/swsetup/swsetup.pl $*`; }
  swsetup samtools
  ...
  uniq=$(uniq <<< "$libs")
  read -a lib < <(sed -n -e "${PBS_ARRAYID}p" <<<"$uniq")
  mkdir -p ${lib[0]}/dedup
  
  files=$(ls ${lib[0]} -1 | grep -v dedup | grep Chr)
  cd ${lib[0]}
    
  parallel -j 20 mv {} {.}.orig.bam <<< "$files"

  parallel -j 20 java -cp /usr/local/igbb/picard-tools-1.140/htsjdk-1.140.jar htsjdk.samtools.FixBAMFile {.}.orig.bam {} <<< "$files"

  parallel -j 5 java -jar $PICARD MarkDuplicates \
      INPUT={} OUTPUT=dedup/{.}.dedup.bam \
      METRICS_FILE={.}.metrics.txt <<< "$files"
  
 
  parallel -j 5 samtools index dedup/{.}.dedup.bam  <<< "$files"
...
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name)
  ...
  PICARD=/usr/local/igbb/picard-tools-1.140/picard.jar
  DB=$DIR/db/G.raimondii_JGI_221_v2.0.assembly

  java -jar $PICARD NormalizeFasta I=$DB.fasta O=$DB.normalized.fasta 
  samtools faidx $DB.normalized.fasta
  java -jar $PICARD CreateSequenceDictionary REFERENCE=$DB.normalized.fasta OUTPUT=$DB.normalized.dict
#+END_SRC

#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/realign/target_creator.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N RealignerTargetCreator -l nodes=1:ppn=20 -l walltime=48:00:00 
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/local/swsetup/swsetup.pl $*`; }
  swsetup samtools
  ...
  PATH=$PATH:/usr/local/gnu/bin/
  PICARD=/usr/local/igbb/picard-tools-1.140/picard.jar
  GATK=/usr/local/igbb/GenomeAnalysisTK-3.4-0/GenomeAnalysisTK.jar
  ALIGN=$DIR/analysis/SNP
  DB=$DIR/db/G.raimondii_JGI_221_v2.0.assembly.normalized.fasta


  uniq=$(uniq <<< "$libs")
  read -a lib < <(sed -n -e "${PBS_ARRAYID}p" <<<"$uniq")

  TMP=$ALIGN/realign/${lib[0]}
  mkdir -p $TMP

  files=$(ls $ALIGN/dedup/${lib[0]}/dedup/*bam | grep Chr)
  
  for file in $files; do
    mkdir $TMP/$(basename ${file%.*}) -p
    java -Djava.io.tmpdir=$TMP/$(basename ${file%.*}) -Xmx3g -jar $GATK -T RealignerTargetCreator -nt 20 -R $DB \
        -I $ALIGN/dedup/${lib[0]}/dedup/$(basename ${file%.*}).bam \
        -o $ALIGN/realign/${lib[0]}/$lib.$(basename ${file%.*}).intervals &> $ALIGN/realign/${lib[0]}/${lib[0]}.$(basename ${file%.*}.)realigner.log
  done;
#+END_SRC

#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/realign/indel_realigner.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N IndelRealigner -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/local/swsetup/swsetup.pl $*`; }
  swsetup samtools
  ...
  parallel -j20 java -Djava.io.tmpdir=$TMP/{/.} -Xmx3g -jar $GATK -T IndelRealigner -R $DB \
           -I {} \
           -targetIntervals $ALIGN/realign/${lib[0]}/${lib[0]}.{/.}.intervals \
           -o $ALIGN/realign/${lib[0]}/{/.}.realigned.bam '&>' {}.indel_realigner.log <<<"$files"

#+END_SRC

*** SKIP Recalibrate

BaseRecalibrator must have know SNPs. Since AD1 doesn't have know SNPs in a
usable format, this set was skipped. To continue with the pipeline,
'*.recal_reads.bam' were symlinked to '*.realigned.bam'.

#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/recal/recalibrator.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N BaseRecalibrator -l nodes=1:ppn=20 -l walltime=48:00:00 -t 1-31
#+BEGIN_SRC sh :var libs=read_groups[,0] :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/erc-share/etc/swsetup/swsetup.pl $*`; }
  swsetup samtools
  ...
  GATK=/usr/local/igbb/GenomeAnalysisTK-3.4-0/GenomeAnalysisTK.jar
  ALIGN=$DIR/analysis/SNP
  DB=$DIR/db/NBI_Gossypium_hirsutum_v1.1.fa

  lib=$(sed -n -e "${PBS_ARRAYID}p" <<<"$libs")

  BAM=$ALIGN/realign/$lib.realigned.bam

  TMP=$ALIGN/tmp/$PBS_JOBID
  mkdir $TMP
  ...
  java -Djava.io.tmpdir=$TMP -jar $GATK \
       ...
       -R $DB \
       -I $BAM \
       -o $ALIGN/recal/$lib.recal_data.table &> $ALIGN/recal/$lib.recalib.log
  ...
  java -Djava.io.tmpdir=$TMP -jar $GATK \
       ...
       -R $DB \
       -I $BAM \
       -BQSR $ALIGN/recal/$lib.recal_data.table \
       -o $ALIGN/recal/$lib.post_recal_data.table &> $ALIGN/recal/$lib.post_recalib.log
  ...
  java -Djava.io.tmpdir=$TMP -jar $GATK \
       ...
       -I $BAM \
       -BQSR $ALIGN/recal/$lib.recal_data.table \
       -o $ALIGN/recal/$lib.recal_reads.bam &> $ALIGN/recal/$lib.print_recalib.log

#+END_SRC
** Variant Discovery (GATK)
*** Call Variants
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call/HaplotypeCaller.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N HaplotypeCaller -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
    swsetup () { eval `/usr/local/swsetup/swsetup.pl $*`; }
    swsetup samtools
    ...
    TMP=$ALIGN/call/tmp/${lib[0]}/
    mkdir -p $TMP
    mkdir -p $ALIGN/call/${lib[0]}
    
    files=$(ls $ALIGN/realign/${lib[0]}/*.realigned.bam)
    for file in $files; do 
        basename=$(basename $file)
        name=${basename%.*}
        mkdir -p $TMP/$name
    ...
    parallel -j20 java -Djava.io.tmpdir=$TMP/{/.} -Xmx3g -jar $GATK -T HaplotypeCaller -R $DB \
             -I $ALIGN/realign/${lib[0]}/{/.}.bam \
             -nct 20 \
             -stand_emit_conf 10 \
             -stand_call_conf 30 \
             ...
             -o $ALIGN/call/${lib[0]}/{/.}.g.raw_variants.vcf '&>' $ALIGN/call/${lib[0]}/{/.}.HaplotypeCaller.log <<<"$files"
#+END_SRC

*** Join VCF
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call/join.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N VCF_JOIN -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
    PATH=$PATH:/usr/local/gnu/bin/
    PICARD=/usr/local/igbb/picard-tools-1.140/picard.jar
    GATK=/usr/local/igbb/GenomeAnalysisTK-3.4-0/GenomeAnalysisTK.jar
    ...
    name="Chr_"$(printf "%02d" $PBS_ARRAYID)
    mkdir -p $ALIGN/call/join/
    cd $ALIGN/call/join
    variants=""
    for i in $(find ../ -name '*vcf' | grep $name); do variants+="--variant $i "; done
    pwd

    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T GenotypeGVCFs -R $DB \
        $variants \
        --out all.$name.vcf \
        -stand_emit_conf 10 \
        -stand_call_conf 30  &> $ALIGN/call/join/$name.joint.genotype.log
#+END_SRC

*** Filter
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call/filter.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N filter -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var DIR=(file-name-directory buffer-file-name) 
    swsetup () { eval `/usr/erc-share/etc/swsetup/swsetup.pl $*`; }
    swsetup samtools
    ...
    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T SelectVariants -R $DB \
        -V all.$name.vcf \
        -selectType SNP \
        -o all.raw_snp.$name.vcf &> $ALIGN/call/join/$name.all.selectVariants_snp.eff

    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T SelectVariants -R $DB \
        -V all.$name.vcf \
        -selectType INDEL \
        -o all.raw_indel.$name.vcf &> $ALIGN/call/join/$name.all.selectVariants_indel.eff

    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T VariantFiltration -R $DB \
        -V all.raw_snp.$name.vcf \
        --filterExpression "QD<2.0||FS>60.0||MQ<40.0||SOR>4.0||MQRankSum<-12.5||ReadPosRankSum<-8.0" \
        --filterName all_snp_filter \
        -o all.filtered_snp.$name.vcf &> $name.all.VariantFiltration_snp.err

    java -Djava.io.tmpdir=$TMP -Xmx3g -jar $GATK -T VariantFiltration -R $DB \
        -V all.raw_indel.$name.vcf \
        --filterExpression "QD<2.0||FS>200.0||SOR>10.0||ReadPosRankSum<-20.0" \
        --filterName indel_filter \
        -o all.filtered_indel.$name.vcf &> $name.all.VariantFiltration_indel.err

    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T SelectVariants -R $DB \
        -V all.filtered_snp.$name.vcf \
        --excludeFiltered \
        -o all.PASS_snp.$name.vcf &> $name.all.PASS_snp.err

    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T SelectVariants -R $DB \
        -V all.filtered_indel.$name.vcf \
        --excludeFiltered \
        -o all.PASS_indel.$name.vcf &> $name.all.PASS_indel.err
#+END_SRC

*** Join Chromosomes
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call/chr_join.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N CHR_JOIN -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,3] :var DIR=(file-name-directory buffer-file-name) 
    PATH=$PATH:/usr/local/gnu/bin/
    PICARD=/usr/local/igbb/picard-tools-1.140/picard.jar
    GATK=/usr/local/igbb/GenomeAnalysisTK-3.4-0/GenomeAnalysisTK.jar
    ...
    mkdir $ALIGN/call/final
    cd $ALIGN/call/final
    variants=""
    for i in $(find ../join/ -name '*PASS*snp*Chr*vcf' | sort); do variants+="--variant $i "; done
    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T CombineVariants -R $DB \
        $variants \
        --out all.PASS_snp.vcf \
        -genotypeMergeOptions UNIQUIFY \
        --minimalVCF &> $ALIGN/call/final/chr.snp.join.log

    variants=""
    for i in $(find ../join/ -name '*PASS*indel*Chr*vcf' | sort); do variants+="--variant $i "; done
    java -Djava.io.tmpdir=$TMP/ -Xmx3g -jar $GATK -T CombineVariants -R $DB \
        $variants \
        --out all.PASS_indel.vcf \
        -genotypeMergeOptions UNIQUIFY \
        --minimalVCF &> $ALIGN/call/final/chr.indel.join.log
#+END_SRC

*** SKIP Joint Genotype
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/genotype/JointGenotype.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N HaplotypeCaller -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups[,0] :var DIR=(file-name-directory buffer-file-name) 

#+END_SRC
** Variant Discovery (Samtools)
#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call_st/merge.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N Merge -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups :var DIR=(file-name-directory buffer-file-name) 
  swsetup () { eval `/usr/erc-share/etc/swsetup/swsetup.pl $*`; }
  swsetup samtools
  ...
  IFS=$'\t'
  while read -a lib; do
      grps[${lib[3]}]+=" INPUT=$ALIGN/realign/${lib[0]}.realigned.bam"
  done <<<"$libs"

  for k in "${!grps[@]}"
  do
      echo java -jar $PICARD MarkDuplicates ${grps[$k]} \
           OUTPUT=$ALIGN/call_st/$k.merge.bam \
           METRICS_FILE=$ALIGN/call_st/$k.metrics.txt \
           VALIDATION_STRINGENCY=LENIENT MAX_FILE_HANDLES_FOR_READ_ENDS_MAP=1000
  done | parallel -j 4


  uniq -f3 <<<"$libs" | \
      awk -F$'\t' \
          '$5 != sample { printf "\nsamtools merge %s/call_st/%s.bam ", align, $5; sample = $5} 
           {printf "%s/call_st/%s.merge.bam ", align, $4}' align=$ALIGN | parallel -j 4
#+END_SRC

#+HEADER: :shebang #!/bin/bash :tangle analysis/SNP/call_st/call.pbs :mkdirp yes
#+HEADER: :prologue #PBS -N Call -l nodes=1:ppn=20 -l walltime=48:00:00
#+BEGIN_SRC sh :var libs=read_groups :var DIR=(file-name-directory buffer-file-name) 
PATH=$PATH:/usr/local/igbb/htslib-1.1/bin/
samtools mpileup -l analysis/QTL_Marker_Location_NBIAD1.bed -go analysis/SNP/call_st/study.bcf \
                 -f db/NBI_Gossypium_hirsutum_v1.1.fa \
                 analysis/SNP/call_st/{SG747,GB713,Ren1,Ren2}.bam
bcftools call -vmO z -o analysis/SNP/call_st/study.vcf.gz analysis/SNP/call_st/study.bcf
tabix -p vcf analysis/SNP/call_st/study.vcf.gz
#+END_SRC
